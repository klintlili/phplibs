...
There is a configuration file called phpsysinfo.ini.new. If this a brand new配置文件
...
phpSysInfo require php-xml extension.需要开启的扩展

Please keep in the mind that because phpSysInfo requires access to many安全模式关闭
